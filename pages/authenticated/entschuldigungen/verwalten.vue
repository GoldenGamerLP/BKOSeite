    ...
    <div class="flex justify-between items-center p-2">
      <div>
        ...
        <p class="text-lg text-muted-foreground mb-8">
          Hier kannst du alle Entschuldigungen sehen.
        ...
        <Select class="col-span-1" v-model="searchType" id="searchType">
          ...
          <SelectContent>
            <SelectGroup>
              ...
              <SelectItem value="nachname"> Nachname </SelectItem>
              <SelectItem value="klasse"> Klasse </SelectItem>
              <SelectItem value="zeitraum"> Zeitraum </SelectItem>
            </SelectGroup>
          </SelectContent>
        </Select>
          ...
          <Select class="w-full" v-model="sortType" id="sortType">
            ...
            <SelectContent>
              <SelectGroup>
                ...
                <SelectItem value="nachname"> A-Z Nachname </SelectItem>
                <SelectItem value="klasse"> A-Z Klasse </SelectItem>
        ...
        <Card class="mb-4">
          <CardHeader>
            ...
            <CardDescription class="text-base"
              >Erstellt am {{ formatDate(entry.erstelltAm) }}
            </CardDescription>
          </CardHeader>
          <CardContent class="grid grid-cols-1 md:grid-cols-2 gap-2">
            ...
            <div>
              ...
              <p class="text-muted-foreground">
                {{ formatDate(entry.zeitraumVon) }} bis zum
            ...
            <div v-if="entry.anlagen">
              ...
              <ol class="flex flex-wrap gap-2">
                <li
                  v-for="file in entry.anlagen"
                  :key="file.filename"
                  alt="Anlage"
                >
                  <NuxtLink
                    class="border border-dashed rounded-lg flex flex-col items-center justify-center p-2"
                    :to="`/api/v1/files/${file.fileId}`"
                    target="_blank"
                    download
                  >
          ...
          <CardFooter>
            <div class="flex gap-2">
              <Select
                ...
                @update:model-value="(value) => updateStatus(entry, value)"
                id="statusSelect"
              >
                <SelectTrigger>
